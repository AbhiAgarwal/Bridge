...
class Profile extends Generic {
	...
	function __construct() {
		...
		if(!empty($_SESSION['bridge']['forcePwUpdate']))
		...
		// Save the username
		$this->username = !empty($_SESSION['bridge']['username']) ? $_SESSION['bridge']['username'] : _('Guest');
	...
	private function determineGuest() {
		...
		if ( !empty($_SESSION['bridge']['user_id']) && empty($_GET['uid']) )
			$this->user_id = $_SESSION['bridge']['user_id'];
		...
		$this->guest = !( !empty($_SESSION['bridge']['user_id']) && $_SESSION['bridge']['user_id'] == $this->user_id );
	...
	private function updateEmailorPw() {
		...
		if(!empty($_SESSION['bridge']['forcePwUpdate'])) unset($_SESSION['bridge']['forcePwUpdate']);
